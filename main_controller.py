...
braderhut = Blueprint('braderhut', __name__)
...
class SearchProductSpec(object):
    def __init__(self):
        self.keyword = None


@braderhut.route('search_product', methods=['POST'])
...
app = Flask(__name__)
app.register_blueprint(braderhut, url_prefix='/')
